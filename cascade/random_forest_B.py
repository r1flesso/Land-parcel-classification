...
from train_val_test_split_B import X_train, X_val, X_test, y_train, y_val, y_test, dict_
...
def objective(trial):
    params = {
        ...
        'min_samples_split': trial.suggest_int('min_samples_split', 325, 525),
...
mlflow.set_experiment(f'Model_B')
